...
public class Library extends ScopeKeyword
{
    ...
    public boolean read_scope(ReadScopeParameter p_par)
    {
        ...
        {
            eu.mihosoft.freerouting.library.Padstack[] via_padstacks = new eu.mihosoft.freerouting.library.Padstack[p_par.via_padstack_names.size()];
            ...
            for (int i = 0; i < via_padstacks.length; ++i)
            {
                ...
                eu.mihosoft.freerouting.library.Padstack curr_padstack = board.library.padstacks.get(curr_padstack_name);
            ...
            if (found_padstack_count != via_padstacks.length)
            {
                ...
                eu.mihosoft.freerouting.library.Padstack[] corrected_padstacks = new eu.mihosoft.freerouting.library.Padstack[found_padstack_count];
        ...
        while (it.hasNext())
        {
            ...
            eu.mihosoft.freerouting.library.Package.Pin[] pin_arr = new eu.mihosoft.freerouting.library.Package.Pin[curr_package.pin_info_arr.length];
            ...
            eu.mihosoft.freerouting.geometry.planar.Shape[] outline_arr = new eu.mihosoft.freerouting.geometry.planar.Shape[curr_package.outline.size()];
            ...
            eu.mihosoft.freerouting.library.Package.Keepout []  keepout_arr = new eu.mihosoft.freerouting.library.Package.Keepout [curr_package.keepouts.size()];
            ...
            for (int i = 0; i < keepout_arr.length; ++i)
            {
                ...
                eu.mihosoft.freerouting.geometry.planar.Area curr_area = Shape.transform_area_to_board_rel(curr_keepout.shape_list, p_par.coordinate_transform);
                keepout_arr[i] = new eu.mihosoft.freerouting.library.Package.Keepout(curr_keepout.area_name, curr_area, curr_layer.no);
            }
            eu.mihosoft.freerouting.library.Package.Keepout []  via_keepout_arr = new eu.mihosoft.freerouting.library.Package.Keepout [curr_package.via_keepouts.size()];
            ...
            for (int i = 0; i < via_keepout_arr.length; ++i)
            {
                ...
                Layer curr_layer = (curr_keepout.shape_list.iterator().next()).layer;
                eu.mihosoft.freerouting.geometry.planar.Area curr_area = Shape.transform_area_to_board_rel(curr_keepout.shape_list, p_par.coordinate_transform);
                via_keepout_arr[i] = new eu.mihosoft.freerouting.library.Package.Keepout(curr_keepout.area_name, curr_area, curr_layer.no);
            }
            eu.mihosoft.freerouting.library.Package.Keepout []  place_keepout_arr = new eu.mihosoft.freerouting.library.Package.Keepout [curr_package.place_keepouts.size()];
            ...
            for (int i = 0; i < place_keepout_arr.length; ++i)
            {
                ...
                Layer curr_layer = (curr_keepout.shape_list.iterator().next()).layer;
                eu.mihosoft.freerouting.geometry.planar.Area curr_area = Shape.transform_area_to_board_rel(curr_keepout.shape_list, p_par.coordinate_transform);
                place_keepout_arr[i] = new eu.mihosoft.freerouting.library.Package.Keepout(curr_keepout.area_name, curr_area, curr_layer.no);
            }
    ...
    public static void write_padstack_scope(WriteScopeParameter p_par, eu.mihosoft.freerouting.library.Padstack p_padstack) throws java.io.IOException
    {
        ...
        for (int i = first_layer_no; i <= last_layer_no; ++i)
        {
            ...
            eu.mihosoft.freerouting.board.Layer board_layer = p_par.board.layer_structure.arr[i];
    ...
    static boolean  read_padstack_scope(Scanner p_scanner, LayerStructure p_layer_structure,
            CoordinateTransform p_coordinate_transform, eu.mihosoft.freerouting.library.Padstacks p_board_padstacks)
    {
        ...
        while (it.hasNext())
        {
            ...
            eu.mihosoft.freerouting.geometry.planar.Shape curr_shape = pad_shape.transform_to_board_rel(p_coordinate_transform);
            eu.mihosoft.freerouting.geometry.planar.ConvexShape convex_shape;
            if (curr_shape instanceof eu.mihosoft.freerouting.geometry.planar.ConvexShape)
            {
                convex_shape = (eu.mihosoft.freerouting.geometry.planar.ConvexShape) curr_shape;
            }
            else
            {
            ...
            eu.mihosoft.freerouting.geometry.planar.ConvexShape padstack_shape = convex_shape;
