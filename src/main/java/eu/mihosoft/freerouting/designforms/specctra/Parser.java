...
public class Parser extends ScopeKeyword
{
     ...
     */
    public static void write_scope(eu.mihosoft.freerouting.datastructures.IndentFileWriter p_file, SpecctraParserInfo p_parser_info,
                                   eu.mihosoft.freerouting.datastructures.IdentifierType p_identifier_type, boolean p_reduced) throws java.io.IOException
    {
        p_file.start_scope();
        p_file.write("parser");
